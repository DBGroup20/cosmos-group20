        ...
        basket.map((item, i) => {
            ...
            fetch(orderIDAPI)
                ...
                .then((data) => {
                    ...
                    fetchedOrderID = data.toString();
                    console.log("fetchOrderID", fetchedOrderID, order_id)
                    orderAPI = "/api/place_order/order_id=" + fetchedOrderID + "&cart_id=" + i.toString() + "&cid=" + user.username + "&pid=" + item.id + "&price=" + item.price + "&quantity=" + item.quantity + "&total=" + total.toString();
                    console.log("oAPI", orderAPI);
                    fetch(orderAPI)
